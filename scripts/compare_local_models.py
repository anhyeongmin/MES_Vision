...
def main():
    ...
    with ExitStack() as stack:
        ...
        sources={'epoch010':ROOT/'artifacts/training/ash-real-reviewed-v3/detail-defects/inference-unvalidated.pth',
                 **{f'epoch{e:03d}':run/'engine'/f'epoch-epoch={e-1:03d}.ckpt' for e in [25,50,75]},'epoch100':final}
        ...
        total=55*16*5;start=time.time();all_results={}
        print(f'OUTPUT: {out}\nModels: 5 | Images per model: 880 | Total: {total}',flush=True)
