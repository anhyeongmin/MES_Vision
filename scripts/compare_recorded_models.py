...
def main():
    ...
    with ExitStack() as stack:
        ...
        from prepare_recorded_training import prepare
        ...
        assert real_meta['condition']=='real'
        assert sha(final)=='4e58419200d37109981f697db4502c0db4a1ac4c494bcda08735cee748a84f55'
        sources={'before_recorded':real_weights,'after_recorded':final}
