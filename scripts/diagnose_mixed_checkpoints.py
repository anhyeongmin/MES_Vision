...
def main():
    ...
    parser.add_argument('--output',default='artifacts/mixed-checkpoint-diagnosis')
    ...
    with ExitStack() as stack:
        ...
        sources={'real_rotation_100':real_weights,**{f'mixed_cad_{e:03d}':run/'engine'/f'epoch-epoch={e-1:03d}.ckpt' for e in [10,20,30,40]},'mixed_cad_050':final}
        ...
        total=55*16*6;start=time.time();all_results={}
        print(f'OUTPUT: {out}\nModels: 6 | Images per model: 880 | Total: {total}',flush=True)
