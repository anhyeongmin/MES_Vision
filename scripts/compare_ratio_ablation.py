...
def main():
    ...
    with ExitStack() as stack:
        ...
        assert real_meta['global_step']==meta['global_step']==1600
        assert real_meta['initial_sha256']==meta['initial_sha256']
        assert real_meta['condition']=='real' and meta['condition']=='mixed25'
        sources={'real_only_050':real_weights,'mixed25_050':final}
